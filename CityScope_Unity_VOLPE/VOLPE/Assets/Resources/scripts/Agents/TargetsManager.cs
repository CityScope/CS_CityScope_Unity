...
public class TargetsManager : MonoBehaviour
{
	...
	float[] targetsValuesArray = new float[100];
	Vector4[] targetsPositionsArray = new Vector4[100];
	...
	void Awake ()
	{
		for (int i = 0; i < transform.childCount; i++) {
			transform.GetChild (i).gameObject.GetComponent<TargetController>()._id = i; 
		}
	}
